...
function colorizeLog(line: string): string {
  if (/error|fail|fatal|panic/i.test(line)) return "text-error";
  if (/success|pass|done|complete|merged/i.test(line)) return "text-accent";
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-[40%] min-w-[400px] z-50 flex flex-col bg-surface-raised border-l-2 border-accent-a40"
          >
            {/* Header */}
            ...
            {/* Search + Step filter */}
            <div className="px-4 py-2 border-b border-neutral-700 space-y-2">
              {/* Search input */}
              <div className="flex items-center gap-2 px-2 py-1.5 bg-surface-base border border-neutral-700">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent text-xs text-neutral-300 placeholder-neutral-600 outline-none font-mono"
                />
                {searchQuery && (
              ...
              <div className="flex flex-wrap gap-1">
                <button
                  ...
                  className={`px-2 py-0.5 text-xs font-mono border transition-colors ${
                    stepFilter === null
                      ? "border-accent text-accent bg-accent-a10"
            ...
            >
              ...
              {filteredLogs.length === 0 && (
                <div className="text-neutral-600 text-xs italic py-4 text-center">
            ...
            <div className="flex items-center justify-between px-4 py-2 border-t border-neutral-700 text-xs text-neutral-500">
